...
def shipment_qr(shipment_id):
    ...
    <body style="font-family:Arial;background:#f1f5f9;padding:30px;text-align:center;">
        ...
        <div style="font-size:22px;background:white;padding:30px;border-radius:12px;display:inline-block;">
            {s.qr_payload()}
        </div>
...
print("registered shipment blueprints")
