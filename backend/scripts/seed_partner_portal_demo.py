...
from app.services.partner_portal_service import PartnerDashboardService
    ...
    booking = MarketplaceBookingService.create_booking(
        {
            ...
            "patient_phone": "0908000001",
            "requested_date": slots[0].slot_date,
        }
    )
    OrderWorkflowService.create_from_booking(booking.id)
    PartnerDashboardService.get_dashboard(mapping.partner_id)
...
def main():
    ...
    with app.app_context():
        ...
        print("\n=== DXCON PARTNER PORTAL DEMO SEED ===\n")
