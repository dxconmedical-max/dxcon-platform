...
RELEASES: tuple[ReleaseSpec, ...] = (
    ...
    ReleaseSpec("enterprise-hardening-pack-2", "Code Quality and Production Standards", (
        ...
        "backend/app/observability/platform_init.py",
        "backend/app/api/ai_v2/batch.py",
        "backend/app/services/result_flag.py",
        "backend/app/services/refund_service.py",
        "backend/app/services/result_gateway_service.py",
        "backend/app/services/ai_interpretation.py",
        "backend/app/services/ai_risk_engine.py",
        "backend/app/services/medical_summary.py",
        "backend/app/services/route_optimizer.py",
        "backend/app/web/auth.py",
        "backend/app/web/scheduling.py",
        "backend/scripts/enterprise_hardening_lib.py",
        "backend/scripts/verify_enterprise_hardening_pack2.py",
        "backend/scripts/blueprint_registry_lib.py",
        "backend/scripts/verify_blueprint_registry.py",
        "backend/scripts/env_safety_lib.py",
        "backend/scripts/verify_env_safety.py",
        "backend/scripts/security_preflight_lib.py",
        "backend/scripts/seed_operations_demo.py",
        "backend/tests/test_enterprise_hardening.py",
        "backend/tests/test_app_factory.py",
        "backend/tests/test_blueprint_registry.py",
    ...
    ReleaseSpec("audit-fix-pack-1", "Repository Hygiene and App Factory Stabilization", (
        ".gitignore",
        "backend/app/__init__.py",
        "backend/app/bootstrap/",
        "backend/app/core/observability.py",
    ...
    ReleaseSpec("sample-collection-production", "Sample Collection Production Workflow", (
        ...
        "backend/app/api/collector/routes.py",
        "backend/app/api/home_collections/",
        "backend/app/api/workflow/routes.py",
        "backend/app/api/mobile/routes.py",
        "backend/app/api/reception/routes.py",
        ...
        "backend/migrations/021_sample_collections_collection_mode.sql",
        "backend/migrations/021_schema_reconciliation.sql",
        "backend/scripts/apply_migrations.py",
        "backend/scripts/generate_schema_reconciliation.py",
        "backend/scripts/verify_schema_reconciliation.py",
        "backend/scripts/apply_sample_collections_marketplace_booking_id.py",
        "backend/scripts/apply_sample_collections_collection_mode.py",
        "backend/tests/test_sample_collection_production.py",
        "backend/tests/test_collection_mode_migration.py",
        "backend/tests/test_collection_mode_routing.py",
        "backend/tests/test_collection_routing_smoke.py",
        "backend/tests/test_reception_home_to_collector_queue.py",
        "backend/tests/test_schema_reconciliation.py",
        "backend/scripts/production_readiness_lib.py",
        "apps/web/src/lib/api/sampleCollection.ts",
        "apps/web/src/app/app/collector/",
        "apps/web/src/app/app/reception/m2/field-requests/",
        "apps/web/src/app/app/reception/workflow/Milestone1Steps.tsx",
    )),
)
