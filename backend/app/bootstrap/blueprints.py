...
from app.api.diagnostic_workflow.routes import diagnostic_workflow_bp
...
from app.web.standards_advanced import standards_advanced_web_bp
...
from app.web.backup_recovery import backup_recovery_web_bp
...
from app.web.healthcare_ecosystem import healthcare_ecosystem_web_bp
...
from app.api.standards_advanced.routes import standards_advanced_bp
...
from app.api.backup_recovery.routes import backup_recovery_bp
...
from app.api.healthcare_ecosystem.routes import healthcare_ecosystem_bp
...
from app.patient_marketplace.routes import patient_marketplace_bp
...
def register_blueprints(app):
    ...
    app.register_blueprint(standards_advanced_bp)
    ...
    app.register_blueprint(backup_recovery_bp)
    ...
    app.register_blueprint(healthcare_ecosystem_bp)
    ...
    app.register_blueprint(standards_advanced_web_bp)
    ...
    app.register_blueprint(partner_foundation_web_bp)
    ...
    app.register_blueprint(diagnostic_workflow_bp)
    ...
    app.register_blueprint(patient_marketplace_bp)
