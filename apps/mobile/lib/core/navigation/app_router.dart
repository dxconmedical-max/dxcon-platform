...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) =>
        redirectForAuth(authState, state.matchedLocation),
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (_, __) => const PatientMarketplaceScreen(),
          ),
          GoRoute(
            path: '/patient/marketplace/tests',
            builder: (_, __) => const PatientMarketplaceScreen(),
          ),
          GoRoute(
            path: '/patient/marketplace/packages',
            builder: (_, __) => const PatientMarketplaceScreen(),
          ),
          GoRoute(
            path: '/patient/marketplace/providers',
            builder: (_, __) => const PatientMarketplaceScreen(),
          ),
          GoRoute(
          ...
          GoRoute(
            ...
            builder: (c, s) =>
                PatientProviderScreen(providerId: s.pathParameters['id']!),
          ),
          GoRoute(
            path: '/patient/bookings',
            builder: (_, __) => const PatientBookingsScreen(),
          ),
          GoRoute(
            path: '/patient/booking/:id',
            builder: (c, s) =>
                PatientBookingDetailScreen(bookingId: s.pathParameters['id']!),
          ),
          GoRoute(
            path: '/patient/payment/:id',
            builder: (c, s) =>
                PatientPaymentScreen(paymentReference: s.pathParameters['id']!),
          ),
          GoRoute(
            path: '/patient/results',
            builder: (_, __) => const PatientResultsScreen(),
          ),
          GoRoute(
            path: '/patient/result/:id',
            builder: (c, s) =>
                PatientResultDetailScreen(reportCode: s.pathParameters['id']!),
          ),
          GoRoute(
            path: '/patient/payments',
            builder: (_, __) => const PatientPaymentsScreen(),
          ),
          GoRoute(
            path: '/patient/invoices',
            builder: (_, __) => const PatientInvoicesScreen(),
          ),
          GoRoute(
            path: '/patient/consultations',
            builder: (_, __) => const PatientConsultationsScreen(),
          ),
          GoRoute(
      ...
      ShellRoute(
        builder: (_, __, child) =>
            CollectorShell(child: child, collectorId: collectorId),
        routes: [
          GoRoute(
            path: '/collector/home',
            builder: (_, __) => CollectorHomeScreen(collectorId: collectorId),
          ),
          GoRoute(
            path: '/collector/jobs',
            builder: (_, __) => CollectorJobsScreen(collectorId: collectorId),
          ),
          GoRoute(
          ...
          GoRoute(
            path: '/collector/sync',
            builder: (_, __) => const CollectorSyncScreen(),
          ),
          GoRoute(
            path: '/collector/incidents',
            builder: (_, __) => const PlaceholderScreen(title: 'Sự cố'),
          ),
          GoRoute(
          ...
          GoRoute(
            ...
            builder: (_, __) => const PlaceholderScreen(title: 'Bàn giao'),
          ),
        ],
      ),
      ShellRoute(
      ...
      ShellRoute(
        builder: (_, __, child) => ExecutiveShell(child: child),
...
/// Auth-aware redirect used by GoRouter (exported for Phase 1 tests).
String? redirectForAuth(AuthState authState, String loc) {
  ...
  if (status == AuthStatus.authenticated && publicRoutes.contains(loc)) {
    return workspaceHomeFor(authState.capabilities?.workspace ?? 'patient');
  }
  return null;
}
