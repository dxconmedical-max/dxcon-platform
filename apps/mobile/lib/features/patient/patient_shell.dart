...
class PatientShell extends WorkspaceShell {
  ...
  @override
  String get workspaceName => 'DxCon Health';

  @override
  List<NavigationDestination> get destinations => const [
        NavigationDestination(icon: Icon(Icons.home_outlined), label: 'Trang chủ'),
        NavigationDestination(icon: Icon(Icons.storefront_outlined), label: 'Dịch vụ'),
        NavigationDestination(icon: Icon(Icons.event_note_outlined), label: 'Đặt lịch'),
